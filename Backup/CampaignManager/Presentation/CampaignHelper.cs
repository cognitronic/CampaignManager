...
namespace CampaignManager.Presentation
{
    public class CampaignHelper
    {
        ...
        {
            get { return HttpSessionHelper.Get<int>("CURRENT_TEMPLATE_ID"); }
            set { HttpSessionHelper.Set("CURRENT_TEMPLATE_ID", value); }
        }

        public static int SelectedCampaignID
        {
            get { return HttpSessionHelper.Get<int>("CURRENT_CAMPAIGN_ID"); }
            set { HttpSessionHelper.Set("CURRENT_CAMPAIGN_ID", value); }
        }
